...
export const verticalMenuItems = [
    ...
    new Menu(2, 'My Partner Dashboard', '/my-partner-dashboard', null, 'supervisor_account', null, false, 0),
    ...
    new Menu(8, 'User Management', null, null, 'computer', null, true, 0),
    new Menu(9, 'Users', '/users', null, 'supervisor_account', null, false, 8),
    new Menu(10, 'User Roles', '/user-roles', null, 'supervisor_account', null, false, 8)
