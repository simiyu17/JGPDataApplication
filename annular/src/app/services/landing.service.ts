...
export class LandingService {
  ...
  getClients() {
    return [
      'img/clients/dream.png',
      'img/clients/congrats.png',
      'img/clients/best.png',
      'img/clients/original.png',
      'img/clients/king.png',
      'img/clients/love.png',
      'img/clients/the.png',
      'img/clients/easter.png',
      'img/clients/with.png',
      'img/clients/special.png',
      'img/clients/bravo.png'
    ];
  }
